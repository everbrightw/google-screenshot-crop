...
//This is a lib for downloading the image
...
var contentURL = '';
let ratio = window.devicePixelRatio;//used specifically for Retina screen to get the image's correct size
...
function saveFile(dataURI) {
	//cant open new window for debugging/ copy the data URI from background console
